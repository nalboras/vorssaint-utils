...
extension CommandBarFeatureStrings {
    ...
    static let pl = CommandBarFeatureStrings(
        pageTitle: "Pasek poleceń",
        hubDescription: "Jedno pole do wyszukiwania i uruchamiania wszystkiego, co potrafi aplikacja",
        panelCaption: "Wpisz, aby znaleźć i uruchomić dowolną funkcję",
        settingsCaption: "Jeden skrót otwiera pole nad tym, co aktualnie robisz. Wpisz kilka liter, naciśnij Return i działanie zostanie wykonane. Nic, co wpisujesz, nie jest zapisywane.",
        openButton: "Otwórz pasek teraz",
        searchPlaceholder: "Wpisz, co chcesz zrobić",
        suggestionsLabel: "Sugestie",
        noResultsTitle: "Nic nie pasuje do tej nazwy.",
        noResultsAction: "Pokaż sugestie",
        argumentRangeFormat: "%d–%d",
        argumentHint: "Return zatwierdza · Esc wraca",
        confirmHint: "Return zatwierdza · Esc anuluje",
        kindApp: "Aplikacja",
        kindClipboard: "Wklej ze schowka",
        kindSnippet: "Wstaw fragment",
        soundOutputSubtitle: "Przełącz wyjście dźwięku",
        soundOutputCurrent: "Bieżące wyjście",
        volumeTitle: "Głośność",
        brightnessTitle: "Jasność ekranu",
        keepAwakeForFormat: "Nie usypiaj przez %@",
        needsSetupFormat: "Włącz %@ w Ustawieniach",
        needsPermissionHint: "Wymaga uprawnienia · Return poprosi o dostęp",
        actionCheckAppUpdates: "Sprawdź aktualizacje aplikacji",
        actionCleanURL: "Wyczyść skopiowany link",
        actionOpenSettings: "Otwórz Ustawienia",
        answerBatteryLabel: "Bateria",
        answerBatteryCharging: "ładowanie",
        answerBatteryPlugged: "podłączone do zasilania",
        answerMemoryLabel: "Pamięć",
        answerMemoryFormat: "używane %@ z %@",
        answerStorageLabel: "Pamięć masowa",
        answerStorageFormat: "dostępne %@ z %@",
        copyHint: "Return kopiuje",
        copyFailed: "Nie udało się skopiować",
        kindWindow: "Okno",
        quitFormat: "Zakończ %@",
        quitConfirmFormat: "Zakończyć %@?",
        kindMenu: "Polecenie menu",
        actionsTitle: "Działania",
        actionsHint: "Działania",
        reuseHint: "Kontynuuj",
        actionPin: "Przypnij na górze",
        actionUnpin: "Odepnij",
        actionName: "Nadaj własną nazwę",
        actionRename: "Zmień nazwę używaną przez wyszukiwanie",
        actionHide: "Nigdy nie pokazuj",
        actionForget: "Zapomnij częstotliwość używania",
        aliasPlaceholder: "Nazwa, której używasz",
        aliasTakenFormat: "%@ odpowiada już tej nazwie",
        sourcesTitle: "Czego szuka pasek",
        sourcesCaption: "Wyłącz to, czego nigdy nie chcesz widzieć. Twoje własne działania pozostają zawsze dostępne.",
        sourceActions: "Działania Vorssaint",
        sourceApps: "Aplikacje",
        sourceMenus: "Polecenia menu aktywnej aplikacji",
        sourceWindows: "Otwarte okna",
        sourceQuitApps: "Zakończ aplikację",
        sourceSettingsPages: "Strony ustawień",
        sourceSnippets: "Fragmenty",
        sourceClipboard: "Historia schowka",
        sourceEmoji: "Emoji",
        sourceFolders: "Foldery",
        sourceAnswers: "Informacje o tym Macu",
        sourceCalculator: "Obliczenia i przeliczenia",
        namedTitle: "Nadane nazwy",
        namedEmpty: "Nie nadano jeszcze nazw. Otwórz pasek, wybierz wiersz i naciśnij klawisz działań.",
        pinnedTitle: "Przypięte",
        pinnedEmpty: "Nic jeszcze nie przypięto.",
        hiddenTitle: "Nigdy nie pokazuj",
        hiddenEmpty: "Nic nie jest ukryte.",
        forgetAllButton: "Zapomnij, czego używam najczęściej",
        tryTheseLabel: "Wypróbuj",
        stillLooking: "Nadal szukam",
        removeButton: "Usuń",
        confirmButton: "Potwierdź",
        soundMute: "Wycisz dźwięk",
        soundUnmute: "Włącz dźwięk ponownie",
        stateOn: "włączone",
        powerSleep: "Uśpij",
        powerRestart: "Uruchom ponownie",
        powerRestartConfirm: "Uruchomić ponownie Maca?",
        powerShutDown: "Wyłącz",
        powerShutDownConfirm: "Wyłączyć Maca?",
        powerLogOut: "Wyloguj",
        powerLogOutConfirm: "Wylogować?",
        wifiOn: "Włącz Wi‑Fi",
        wifiOff: "Wyłącz Wi‑Fi",
        kindEmoji: "Emoji",
        kindFolder: "Folder",
        answerDateLabel: "Dzisiaj",
        answerTimeLabel: "Aktualny czas",
        kindAnswer: "Odpowiedź",
        kindSelection: "Zaznaczenie",
        selectedTitle: "Zaznaczone",
        selectionCopy: "Kopiuj",
        selectionSearch: "Użyj w wyszukiwaniu",
        selectionUpper: "WIELKIE LITERY",
        selectionLower: "małe litery",
        selectionTitleCase: "Jak w tytule",
        selectionShelf: "Odłóż na półkę",
        selectionCount: "Policz",
        selectionCountFormat: "Słowa: %d, znaki: %d",
        sourceSelection: "Co jest zaznaczone",
        kindLink: "Twój skrót",
        linkSearchHint: "Wpisz, czego szukać po nazwie",
        linksTitle: "Twoje skróty",
        linksEmpty: "Nic nie zapisano. Dodaj witrynę, folder, wyszukiwanie lub skrypt używany na co dzień.",
        linkDestinationLabel: "Miejsce docelowe",
        linkKindLink: "Witryna lub link",
        linkKindPlace: "Folder lub plik",
        linkPlaceholdersHint: "Umieść jeden z tych znaczników, a zostanie uzupełniony podczas otwierania",
        placeholderQuery: "wpisywany tekst",
        placeholderClipboard: "skopiowana zawartość",
        placeholderSelection: "zaznaczona zawartość",
        placeholderDate: "dzisiaj",
        privacyNote: "Wszystko odbywa się na tym Macu: bez konta, chmury i wysyłania danych.",
        actionShortcut: "Nadaj skrót",
        actionShortcutChange: "Zmień skrót",
        actionShortcutRemove: "Usuń skrót",
        shortcutCaptureHint: "Naciśnij wybrane klawisze · Delete usuwa · Esc wraca",
        rowShortcutsTitle: "Wiersze z własnym skrótem",
        rowShortcutsEmpty: "Żaden wiersz nie ma jeszcze własnego skrótu. Otwórz działania dowolnego wiersza, aby go nadać.",
        appCenterTitle: "Skróty aplikacji",
        appCenterCaption: "Otwieraj aplikacje własnymi skrótami nawet przy zamkniętym pasku. Ustaw tutaj nazwy wyszukiwania i przypinaj ulubione.",
        appAliasLabel: "Alias",
        appShortcutLabel: "Skrót",
        appShortcutsFilter: "Ze skrótami",
        appShortcutRecord: "Nagraj…",
        rowShortcutsLimitFormat: "Możesz przypisać maksymalnie %d skrótów. Usuń jeden, aby dodać kolejny.",
        turnOnFormat: "Włącz %@",
        turnOffFormat: "Wyłącz %@",
        everythingTitle: "Wszystko, co potrafi",
        categoryAll: "Wszystko",
        restartAppFormat: "Uruchom ponownie %@",
        forceQuitAppFormat: "Wymuś zakończenie %@…",
        forceQuitAppConfirmFormat: "Wymusić zakończenie %@? Niezapisane zmiany zostaną utracone.",
        uninstallAppFormat: "Odinstaluj %@…",
        openInBrowser: "Otwórz w przeglądarce",
        linkKindScript: "Skrypt",
        scriptHint: "Wybierz plik wykonywalny. Wpisz jego nazwę, a następnie to, co chcesz mu przekazać. Uruchomi się po chwili oczekiwania i pokaże wynik tutaj.",
        scriptRunsWithoutArgument: "Uruchamiaj także po samym wpisaniu nazwy",
        scriptRunsDirectly: "Uruchamiaj globalnym skrótem bez otwierania paska",
        scriptRunFailed: "Nie udało się uruchomić tego pliku",
        scriptSearchHint: "Wpisz po nazwie to, co chcesz przekazać",
        scriptBareSearchHint: "Uruchamia się samodzielnie albo wpisz to, co chcesz przekazać",
        linkAddButton: "Dodaj skrót",
        positionCaption: "Przeciągnij znacznik po lewej stronie pola, aby umieścić pasek w dowolnym miejscu ekranu; kliknij go dwukrotnie, aby wyśrodkować.",
        resetPositionButton: "Wyśrodkuj pasek",
        shortcutToggle: "Globalny skrót otwierający pasek",
        dragHint: "Przeciągnij, aby przenieść · Kliknij dwukrotnie, aby wyśrodkować",
        actionRevealInFinder: "Pokaż w Finderze",
        sourceMacSettings: "Panele Ustawień systemowych",
        sourceFiles: "Pliki",
        filesTitle: "Szukaj w plikach",
        filesCaption: "Wskaż foldery do przeszukania, a pasek będzie znajdował pliki po nazwie podczas pisania. Nic nie jest indeksowane i nie są wymagane dodatkowe uprawnienia: używane jest wyszukiwanie systemowe Maca i pokazywane są tylko elementy, które już widzisz w Finderze.",
        filesEmpty: "Nie dodano jeszcze folderów, więc pasek nie szuka plików.",
        filesAddFolder: "Dodaj folder",
        filesIgnoreCaption: "Nazwy, których nie warto nigdy pokazywać: cały folder lub plik albo rozszerzenie zapisane jako *.log.",
        filesIgnorePlaceholder: "Nazwa folderu lub pliku",
        filesIgnoreAdd: "Dodaj",
        compactModeToggle: "Tryb kompaktowy",
        compactModeCaption: "Pasek otwiera się bez sugestii. Wyniki pojawiają się podczas pisania.",
        emojiSkinToneLabel: "Odcień skóry",
        emojiSkinToneCaption: "Domyślnie emoji obsługujące odcień używają tego ustawienia. Otwórz działania wiersza emoji, aby wybrać inny.",
        asciiLayoutToggle: "Przełącz na układ ABC podczas otwarcia paska",
        asciiLayoutCaption: "Pole wpisuje znaki łacińskie niezależnie od aktywnego układu, a po zamknięciu paska przywraca poprzedni układ."
    )
