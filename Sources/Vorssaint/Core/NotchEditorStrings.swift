...
extension FeatureStrings {
    static func notchEditor(_ language: AppLanguage) -> NotchEditorStrings {
        ...
        case .pl: return NotchEditorStrings(
            layout: "Układ",
            content: "Zawartość",
            activity: "Aktywność",
            behavior: "Zachowanie",
            layoutHint: "Kliknij +, aby dodać przycisk. Przeciągaj przyciski wokół wyspy. Kliknij przycisk, aby go edytować.",
            ...
            findAction: "Znajdź działanie",
            reorderHint: "Przeciągnij, aby zmienić kolejność. Kliknij znacznik wyboru, aby pokazać lub ukryć.",
            opening: "Otwieranie",
            clickOpen: "Kliknij, aby otworzyć",
            hoverPreview: "Podgląd po najechaniu",
            hoverExpand: "Rozwijaj po najechaniu",
            hiddenUntilHover: "Ukryte do momentu najechania",
            resting: "W spoczynku",
            destinations: "Gdzie otwierać",
            separate: "Osobne okno",
            feedback: "Wskaźniki",
            privacy: "Prywatność",
            reopening: "Przy ponownym otwieraniu",
            lastPage: "Ostatnia strona",
            activationTime: "Czas aktywacji",
            activationTimeHint: "Przytrzymaj wskaźnik nad wyspą przez ten czas, aby ją otworzyć.",
            activationTimeFormat: "%.2f s",
            enableFeatureFormat: "Włącz „%@” w sekcji Funkcje.",
            enableSettingFormat: "Włącz „%@” w ustawieniach tej funkcji.",
            showPageFormat: "Pokaż „%@” na karcie Zawartość.",
            keyboardLightUnavailable: "Sterowanie podświetleniem klawiatury jest niedostępne na tym Macu.",
            appPanelHint: "Wybierz, gdzie otwiera się panel aplikacji po kliknięciu ikony Vorssaint na pasku menu, na dowolnym ekranie.",
            sections: "Sekcje",
            sectionsHint: "Przeciągaj, aby zmieniać kolejność. Usuń zaznaczenie sekcji, aby ukryć ją na wyspie.",
            preview: "Podgląd",
            hiddenInIsland: "Ukryte na wyspie",
            openFeatures: "Otwórz Funkcje",
            cameraPreview: "Kamera jest włączana tylko na wyspie.",
            noOptions: "Ta sekcja nie ma opcji.",
            controlsSummary: "Odtwarzanie, głośność, jasność i skróty.",
            mixerSummary: "Głośność każdej aplikacji i miejsce odtwarzania dźwięku.",
            musicSummary: "Aktualnie odtwarzany utwór wraz ze sterowaniem.",
            clipboardSummary: "Ostatnio skopiowane elementy, gotowe do ponownego wklejenia.",
            capturesSummary: "Najnowsze zrzuty ekranu i nagrania.",
            filesSummary: "Półka na pliki upuszczane na wyspę.",
            systemSummary: "CPU, pamięć, dysk, sieć i bateria w jednym miejscu.",
            toolsSummary: "Narzędzia i funkcje dostępne jednym kliknięciem.",
            calendarSummary: "Dzisiejsze wydarzenia i nadchodzący miesiąc.",
            notificationsSummary: "Powiadomienia Maca przechowywane na wyspie.",
            timerSummary: "Timer, Pomodoro i stoper.",
            cameraSummary: "Podgląd z kamery przed rozmową.",
            downloadsSummary: "Pobrania w toku i ostatnio zakończone.",
            scratchpadSummary: "Szybkie notatki zapisywane automatycznie.",
            agentsSummary: "Użycie, limity i koszty Claude Code oraz Codex."
        )
