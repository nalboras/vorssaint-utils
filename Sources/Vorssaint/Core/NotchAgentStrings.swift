...
extension NotchAgentStrings {
    ...
    static let pl = NotchAgentStrings(
        title: "Agenci AI",
        hubDescription: "Śledź limity planu, tokeny, wartość API i bieżące zadania Claude i Codex w Dynamic Island.",
        settingsDescription: "Odczytuje zużycie zapisywane na tym Macu przez Claude Code i Codex oraz limity planu zapisane przez aplikację Claude. Prompty, odpowiedzi i pliki nie są przechowywane, a dane o użyciu nie opuszczają Maca.",
        ...
        activityCard: "Aktywność",
        today: "Dzisiaj",
        week: "7 dni",
        month: "30 dni",
        session: "Sesja",
        weekly: "Tydzień",
        estimated: "Szacowane na podstawie tego Maca",
        claudeLimitsHint: "Skonfiguruj limity planu…",
        waitingForLimits: "Limity pojawią się po następnej odpowiedzi",
        noSession: "Brak aktywnej sesji",
        apiValue: "Wartość API",
        tokensFormat: "%@ tokenów",
        cachedFormat: "%@ z pamięci podręcznej",
        writtenFormat: "%@ zapisanych",
        savedFormat: "%@ zapisanych w pamięci podręcznej",
        planMultipleFormat: "%1$@ w cenie %2$@",
        idle: "Bezczynny",
        noActivity: "Brak aktywności w tym okresie",
        empty: "Brak użycia Claude Code lub Codex. Dane pojawią się tutaj, gdy którykolwiek z nich zacznie pracować na tym Macu.",
        loading: "Odczytywanie danych…",
        noCards: "Wybierz w ustawieniach Dynamic Island, co ma być wyświetlane na tej stronie.",
        unpriced: "Niektóre modele nie mają znanej ceny, więc jest to wartość minimalna.",
        streak: "Dni z rzędu",
        activeDays: "Aktywne dni",
        busiestDay: "Najbardziej aktywny dzień",
        finishedFormat: "%@ — zakończono",
        limitRenewed: "Limit odnowiony",
        budgetTitle: "Dzienny budżet",
        leftFormat: "Pozostało %@",
        usedFormat: "Wykorzystano %@",
        agents: "Agenci",
        found: "Znaleziono na tym Macu",
        notFound: "Nie znaleziono na tym Macu",
        cardsTitle: "Karty",
        cardsHint: "Przeciągaj, aby zmieniać kolejność. Wykresy zajmują całą szerokość wyspy.",
        limitsAs: "Pokazuj limity jako",
        remaining: "Pozostało",
        used: "Wykorzystano",
        liveTitle: "Podczas pracy agenta",
        liveActivity: "Pokazuj w zamkniętej Dynamic Island",
        readout: "Obok kamery",
        readoutElapsed: "Czas",
        readoutTokens: "Zapisane tokeny",
        readoutLimit: "Limit",
        alerts: "Alerty",
        finishAlert: "Po zakończeniu zadania",
        finishAfter: "Dla zadań dłuższych niż",
        anyLength: "Dowolna długość",
        limitAlert: "Zbliża się limit planu",
        limitAt: "Ostrzegaj przy",
        budget: "Dzienny budżet wartości API",
        off: "Wyłączone",
        updatedFormat: "Zaktualizowano %@",
        claudeLimitsTitle: "Limity planu Claude",
        claudeLimitsCurrentFormat: "Odczytane z aplikacji Claude, zaktualizowane %@",
        claudeLimitsStaleFormat: "Aplikacja Claude sprawdziła je ostatnio %@.",
        claudeLimitsMenuBar: "Claude sprawdza limity tylko wtedy, gdy jego ikona jest na pasku menu. Włącz ją w ustawieniach aplikacji Claude, a limity pojawią się tutaj w ciągu kilku minut.",
        claudeLimitsNoApp: "Limity planu pochodzą z aplikacji Claude, której nie ma na tym Macu. Do tego czasu 5-godzinna sesja jest szacowana na podstawie aktywności Claude Code.",
        claudeLimitsPrivacy: "Vorssaint odczytuje wartości procentowe zapisane przez aplikację Claude na tym Macu. Logowanie nie jest używane i nic nie jest wysyłane.",
        openClaude: "Otwórz Claude",
        getClaude: "Pobierz aplikację Claude",
        priceUpdates: "Aktualizuj ceny",
        priceUpdatesHint: "Raz dziennie pobiera publiczną listę cen z GitHuba, aby nowe modele otrzymywały wartość API bez aktualizacji aplikacji. Żadne dane o Twoim użyciu nie są wysyłane.",
        pricesFromFormat: "Lista cen z %@",
        valueNote: "Wartość API to koszt tej samej pracy według cen katalogowych API. Plany mają natomiast stałą cenę."
    )
