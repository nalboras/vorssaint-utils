...
extension RecorderFeatureStrings {
    ...
    static let pl = RecorderFeatureStrings(
        pageTitle: "Nagrywanie ekranu",
        hubDescription: "Nagrywaj obszar, okno lub cały ekran, a następnie edytuj nagranie",
        panelCaption: "Nagraj obszar, okno lub cały ekran",
        startButton: "Nagraj teraz",
        stopButton: "Zatrzymaj nagrywanie",
        fileNamePrefix: "Nagranie",
        selectionPurpose: "Wybierz, co nagrywać",
        indicatorTooltip: "Sterowanie nagrywaniem",
        countdownLabel: "Odliczanie",
        countdownOff: "Wyłączone",
        countdownSecondsFormat: "%d s",
        qualityLabel: "Jakość",
        qualitySmall: "Mały plik",
        qualityBalanced: "Zrównoważona",
        qualityHigh: "Wysoka",
        qualityCaption: "Zrównoważona jakość pasuje do większości zastosowań. Wysoka zachowuje każdy szczegół, ale tworzy większe pliki.",
        frameRateLabel: "Klatki na sekundę",
        frameRateFormat: "%d kl./s",
        systemAudioToggle: "Nagrywaj dźwięk Maca",
        systemAudioCaption: "Wszystko, co słyszysz, trafi do nagrania na osobnej ścieżce, dzięki czemu można później wyciszyć ten dźwięk.",
        ...
        saveButton: "Zapisz",
        discardButton: "Usuń",
        copiedHUD: "Nagranie skopiowane",
        savedHUDFormat: "Zapisano w %@",
        recordFailed: "Nie udało się nagrać ekranu",
        noSpaceTitle: "Za mało miejsca na nagranie",
        noSpaceMessage: "Zwolnij trochę miejsca na dysku i spróbuj ponownie.",
        stoppedNoSpaceHUD: "Nagrywanie zatrzymane, dysk jest prawie pełny",
        shortcutLabel: "Skrót",
        editorTitle: "Nagranie",
        saveVideoButton: "Zapisz",
        saveGIFButton: "Zapisz jako GIF",
        exportingLabel: "Zapisywanie…",
        cancelButton: "Anuluj",
        exportFailed: "Nie udało się zapisać nagrania",
        gifTooLongFormat: "GIF może mieć maksymalnie %d sekund",
        gifSizeLabel: "Rozmiar GIF",
        gifSizeSmall: "Mały",
        gifSizeMedium: "Średni",
        gifSizeLarge: "Duży",
        gifFrameRateLabel: "Płynność GIF",
        discardTitle: "Usunąć to nagranie?",
        discardMessage: "Nie zostało jeszcze nigdzie zapisane.",
        openEditorToggle: "Otwieraj edytor po nagraniu",
        openEditorCaption: "Nagranie otworzy się gotowe do przycięcia, wyciszenia i zapisania. Wyłącz tę opcję, aby od razu otrzymać plik.",
        lookLabel: "Wygląd",
        lookRaw: "Oryginalny",
        lookClean: "Gładki",
        lookStudio: "Studyjny",
        lookCaption: "Punkt wyjścia. Zmień dowolną opcję poniżej, a zmiana zostanie zachowana.",
        pointerSectionLabel: "Wskaźnik",
        pointerShowToggle: "Rysuj wskaźnik",
        pointerSmoothingLabel: "Wygładzanie",
        pointerSmoothingOff: "Brak",
        pointerSmoothingLight: "Lekkie",
        pointerSmoothingSmooth: "Płynne",
        pointerSmoothingCinematic: "Filmowe",
        pointerSizeLabel: "Rozmiar",
        clickRingToggle: "Zaznaczaj miejsce kliknięcia",
        zoomSectionLabel: "Powiększenie",
        zoomToggle: "Powiększaj przy każdym kliknięciu",
        zoomAmountLabel: "Stopień zbliżenia",
        backgroundSectionLabel: "Tło",
        shapeLabel: "Kształt",
        shapeOriginal: "Oryginalny",
        shapeWide: "Szeroki",
        shapeSquare: "Kwadratowy",
        shapeVertical: "Pionowy",
        noPointerNote: "To nagranie nie zawiera ścieżki wskaźnika, więc nie ma czego wygładzać. Ręcznie dodane powiększenia nadal działają.",
        zoomLaneEmptyHint: "Kliknij tutaj, aby dodać powiększenie",
        addZoomButton: "Dodaj powiększenie",
        removeZoom: "Usuń",
        thisZoomLabel: "To powiększenie",
        zoomWhereLabel: "Miejsce podglądu",
        zoomFollowsPointer: "Podążaj za wskaźnikiem",
        zoomPickSpot: "Wybierz miejsce",
        zoomPickSpotHint: "Kliknij obraz, aby wskazać miejsce",
        regenerateZooms: "Wróć do jednego powiększenia na kliknięcie",
        backToOptions: "Wszystkie opcje",
        cutOutButton: "Wytnij",
        cutHint: "Przeciągnij po taśmie, aby wybrać fragment do usunięcia",
        addTextButton: "Dodaj tekst",
        textLaneEmptyHint: "Kliknij tutaj, aby dodać tekst",
        thisTextLabel: "Ten tekst",
        textPlaceholder: "Wpisz tekst",
        textContentLabel: "Tekst",
        textSizeLabel: "Rozmiar",
        textPositionLabel: "Położenie",
        textColorLabel: "Kolor",
        removeText: "Usuń",
        copyAndDeleteButton: "Kopiuj i usuń",
        saveAsButton: "Zapisz jako…",
        discardSavedMessage: "Zapisane i skopiowane pliki pozostaną na swoich miejscach.",
        presetsButton: "Ustawienia wstępne",
        savePreset: "Zapisz bieżące ustawienie…",
        presetNamePlaceholder: "Nazwa ustawienia",
        removePreset: "Usuń ustawienie",
        zoomEmptyTitle: "Brak powiększeń",
        zoomEmptyCaption: "Utwórz je na podstawie kliknięć albo dodaj powiększenie na osi czasu.",
        createAutomaticZooms: "Utwórz automatyczne powiększenia",
        typingZoomToggle: "Pozostawiaj powiększenie podczas pisania",
        typingZoomCaption: "Po kliknięciu pisanie utrzymuje automatyczne powiększenie w tym miejscu.",
        microphoneToggle: "Nagrywaj mikrofon",
        microphoneCaption: "Twój głos trafia na osobną ścieżkę i pozostaje regulowany w edytorze.",
        systemAudioTrackLabel: "Dźwięk Maca",
        microphoneTrackLabel: "Mikrofon",
        audioVolumeLabel: "Głośność",
        removeAudio: "Usuń",
        restoreAudio: "Przywróć",
        microphoneUnavailableHUD: "Mikrofon niedostępny",
        microphonePermissionName: "Mikrofon",
        microphonePermissionExplain: "Pozwala dołączać Twój głos do nagrań ekranu po włączeniu tej opcji.",
        automaticZoomToggle: "Dodawaj powiększenia automatycznie",
        automaticZoomCaption: "Wyłącz tę opcję, aby nowe nagrania zaczynały się bez powiększeń. Nadal możesz dodawać je w edytorze.",
        pauseButton: "Wstrzymaj nagrywanie",
        resumeButton: "Wznów nagrywanie",
        blurLaneLabel: "Rozmycie",
        addBlurButton: "Rozmyj obszar",
        blurLaneEmptyHint: "Kliknij tutaj, aby dodać rozmycie",
        thisBlurLabel: "To rozmycie",
        blurPickArea: "Wybierz obszar",
        blurPickAreaHint: "Przeciągnij po obszarze, który ma pozostać ukryty",
        blurCaption: "Ukryty przez cały czas, w którym jego blok znajduje się na osi czasu.",
        addImageButton: "Dodaj obraz",
        imageLaneLabel: "Obraz",
        imageLaneEmptyHint: "Kliknij tutaj, aby dodać obraz",
        thisImageLabel: "Ten obraz",
        imageSizeLabel: "Rozmiar",
        imageOpacityLabel: "Krycie",
        imagePositionLabel: "Położenie",
        imageImportFailed: "Nie udało się dodać tego obrazu."
    )
