...
extension FeatureHubStrings {
    ...
    static let pl = FeatureHubStrings(
        pageTitle: "Funkcje",
        intro: "Instaluj tylko to, czego używasz. Odinstalowana funkcja znika z całej aplikacji i przestaje być ładowana.",
        tabFeatures: "Funkcje",
        tabPermissions: "Uprawnienia",
        activeCountFormat: "%1$d z %2$d zainstalowanych funkcji",
        monitorAllOffNote: "Gdy wszystko jest wyłączone, Monitor znika z panelu i paska menu.",
        titleDockClick: "Kliknięcia Docka",
        titleMouseNavigation: "Przyciski boczne",
        titleMusicBlock: "Blokowanie aplikacji Muzyka",
        groupWindowsDock: "Okna i Dock",
        groupMouseKeyboard: "Mysz i klawiatura",
        groupClipboardFiles: "Schowek i pliki",
        groupSound: "Dźwięk",
        groupEnergyDisplay: "Zasilanie i ekran",
        groupTools: "Narzędzia",
        groupMonitor: "Monitor systemu",
        permissionsIntro: "Sprawdź, do czego służy każde uprawnienie i które funkcje z niego korzystają. Pozostałe uprawnienia są żądane dopiero wtedy, gdy ich używasz.",
        usedByFormat: "Używane przez: %@",
        usedByNone: "Żadna włączona funkcja nie korzysta teraz z tego uprawnienia.",
        unusedBanner: "To uprawnienie zostało przyznane, ale żadna włączona funkcja go nie potrzebuje. Możesz je odebrać w Ustawieniach systemowych.",
        statusGranted: "Przyznane",
        statusMissing: "Nieprzyznane",
        statusUnknown: "Aplikacja nie może sprawdzić tego uprawnienia",
        requestButton: "Poproś o dostęp",
        openSystemSettings: "Otwórz Ustawienia systemowe",
        permAccessibility: "Dostępność",
        permScreenRecording: "Nagrywanie ekranu",
        permFullDisk: "Pełny dostęp do dysku",
        permFilesAndFolders: "Pliki i foldery",
        permNotifications: "Powiadomienia",
        permAutomationFinder: "Automatyzacja Findera",
        permAutomationTerminal: "Automatyzacja Terminala",
        permAudioCapture: "Dźwięk aplikacji",
        explainAccessibility: "Pozwala funkcjom reagować na kliknięcia i klawisze oraz przenosić okna.",
        explainScreenRecording: "Pozwala funkcjom wyświetlać podglądy okien i odczytywać tekst z ekranu.",
        explainFullDisk: "Pozwala Oczyszczaniu i dezinstalatorowi znajdować pozostałe pliki w całym systemie.",
        explainFilesAndFolders: "Pozwala funkcji porządkowania pobranych plików WhatsApp oraz eksperymentalnemu organizerowi analizować folder Pobrane.",
        explainNotifications: "Pozwala aplikacji wysyłać powiadomienia o włączonych alertach.",
        explainAutomationFinder: "Pozwala aplikacji zlecać Finderowi przenoszenie plików.",
        explainAutomationTerminal: "Pozwala poleceniom Homebrew otwierać się w Terminalu.",
        explainAudioCapture: "Pozwala mikserowi regulować głośność poszczególnych aplikacji, wyświetlać poziomy dźwięku w Dynamic Island oraz dodawać dźwięk Maca do nagrań ekranu.",
        descSwitcher: "Przełączaj aplikacje i okna z podglądami",
        descDockPreview: "Podglądy okien po najechaniu na Dock",
        descDockClick: "Kliknij ikonę Docka, aby minimalizować lub przełączać okna",
        descWindowMaximizer: "Zielony przycisk maksymalizuje okno zamiast przechodzić do pełnego ekranu",
        descWindowLayout: "Układaj okna skrótami lub przez przyciąganie do krawędzi, a potem przesuwaj je",
        descAutoQuit: "Kończ aplikacje po zamknięciu ich ostatniego okna",
        descScrollInverter: "Odwracaj kierunek przewijania myszy",
        descSmoothScroll: "Płynne, animowane przewijanie myszy",
        descMouseNavigation: "Boczne przyciski myszy działają jako Wstecz i Dalej",
        descMiddleClick: "Kliknięcie trzema palcami działa jak środkowy przycisk myszy",
        descKeyboardDebounce: "Ignoruj przypadkowe podwójne naciśnięcia klawiszy",
        descClipboardHistory: "Prowadź lokalną historię skopiowanych elementów",
        descPastePlain: "Wklejaj tekst bez formatowania",
        descFinderCutPaste: "Wycinaj i wklejaj pliki w Finderze",
        descShelf: "Odkładaj pliki na pasku menu, aby przechować je na później",
        descURLCleaner: "Usuwaj parametry śledzące ze skopiowanych linków",
        descMixer: "Głośność aplikacji, przypinanie i własna kolejność",
        descSoundOutputSwitcher: "Przełączaj wyjścia dźwięku skrótem",
        descMicMute: "Wyciszaj mikrofon z dowolnego miejsca",
        descMusicBlock: "Blokuj uruchamianie Muzyki po wykryciu klawiszy multimedialnych",
        descKeepAwake: "Nie pozwalaj Macowi zasypiać na żądanie",
        descExtraBrightness: "Dodatkowa jasność na ekranach XDR",
        descQuickLauncher: "Pływający panel z ulubionymi narzędziami",
        descColorPicker: "Wybieraj dowolny kolor z ekranu",
        descScreenOCR: "Kopiuj tekst lub kody QR z ekranu",
        descCleaningMode: "Blokuj klawiaturę i ekran podczas czyszczenia",
        descMediaTools: "Kompresuj wideo, obrazy i GIF-y",
        descCleaner: "Czyść pamięć podręczną i niepotrzebne pliki",
        descUninstaller: "Usuwaj aplikacje i pozostałe po nich pliki",
        ...
        footerNote: "Odinstalowanie niczego nie usuwa: funkcja znika tylko z aplikacji i przestaje być ładowana. Możesz ją ponownie zainstalować w dowolnym momencie, a wszystko wróci do poprzedniego stanu.",
        restartNote: "Funkcje odinstalowane w tej sesji pozostają załadowane do czasu ponownego uruchomienia aplikacji. Uruchom ją ponownie, aby od razu usunąć je z pamięci.",
        restartButton: "Uruchom ponownie",
        installAllButton: "Zainstaluj wszystkie",
        uninstallAllButton: "Odinstaluj wszystkie",
        presetsTitle: "Zacznij od pakietu",
        presetsCaption: "Jednym kliknięciem skonfigurujesz aplikację pod swój sposób korzystania z Maca. Wszystko inne pozostaje dostępne jednym kliknięciem.",
        presetEssentialName: "Podstawowe",
        presetEssentialDesc: "Mikser głośności, monitor systemu i Nie usypiaj.",
        ...
        presetBatteryDesc: "Lekki monitor z baterią, pamięcią i procesorem. Nic nie nasłuchuje wejścia.",
        presetApplyButton: "Zastosuj",
        presetConfirmFormat: "Zainstalować pakiet %1$@ i odinstalować pozostałe? Nic nie zostanie usunięte, a wszystko będzie można przywrócić jednym kliknięciem.",
        presetConfirmApply: "Zastosuj pakiet",
        presetConfirmCancel: "Anuluj",
        energyIdle: "Brak aktywności",
        energyMouse: "Nasłuchuje myszy",
        energyPointer: "Nasłuchuje ruchów wskaźnika",
        energyKeyboard: "Nasłuchuje klawiatury",
        energyInputs: "Nasłuchuje myszy i klawiatury",
        energyPeriodic: "Sprawdza w określonych odstępach",
        energyHelp: "Pokazuje, co dana funkcja pozostawia aktywne podczas działania. Odinstalowane funkcje nie ładują niczego.",
        explainAppManagement: "Pozwala aktualizować lub usuwać aplikacje zainstalowane przez menedżer pakietów.",
        onboardingSelectedPermissionsTitle: "Uprawnienia potrzebne do wybranych funkcji",
        onboardingNoSelectedPermissions: "Aby zakończyć konfigurację, nie musisz przyznawać żadnego uprawnienia.",
        onboardingOtherPermissionsTitle: "Inne uprawnienia",
        onboardingOtherPermissionsCaption: "Opcjonalne. Możesz przyznać je teraz albo później, gdy funkcja będzie ich potrzebować.",
        notchUninstallTitle: "Odinstaluj Dynamic Island",
        notchUninstallMessageFormat: "Te rozszerzenia działają tylko w Dynamic Island: %@. Odinstalować je również? Nic nie zostanie usunięte i wszystko będzie można przywrócić jednym kliknięciem.",
