...
extension RadialMenuFeatureStrings {
    ...
    static let pl = RadialMenuFeatureStrings(
        pageTitle: "Menu promieniste",
        hubDescription: "Otwiera wokół wskaźnika koło z ulubionymi działaniami",
        enableLabel: "Używaj menu promienistego",
        enableCaption: "Przytrzymaj skrót, wskaż działanie i puść. Krótkie naciśnięcie pozostawia menu otwarte.",
        positionLabel: "Otwieraj",
        positionPointer: "Przy wskaźniku",
        positionCenter: "Na środku ekranu",
        tryButton: "Wypróbuj",
        actionsHeader: "Działania",
        addButton: "Dodaj działanie",
        limitCaption: "Koło mieści maksymalnie 12 działań.",
        emptyCaption: "Nie ma tu jeszcze żadnych działań.",
        backButton: "Wstecz",
        editActionsButton: "Edytuj działania",
        nameLabel: "Nazwa",
        automaticLabel: "Automatycznie",
        iconLabel: "Ikona",
        actionLabel: "Działanie",
        kindApp: "Otwórz aplikację",
        kindFile: "Otwórz plik lub folder",
        kindURL: "Otwórz link",
        kindShortcut: "Naciśnij skrót",
        kindTool: "Narzędzie Vorssaint",
        kindMedia: "Sterowanie multimediami",
        kindSubmenu: "Podmenu",
        chooseButton: "Wybierz…",
        urlPlaceholder: "example.com",
        urlInvalid: "Wpisz prawidłowy link.",
        toolLabel: "Narzędzie",
        mediaLabel: "Sterowanie",
        mediaPlayPause: "Odtwórz lub wstrzymaj",
        mediaPrevious: "Poprzedni utwór",
        mediaNext: "Następny utwór",
        mediaNowPlaying: "Teraz odtwarzane",
        mediaNothingPlaying: "Nic nie jest odtwarzane",
        mediaOpenAppFormat: "Otwórz %@",
        submenuCaption: "Otwiera drugie koło z własnym zestawem działań.",
        saveButton: "Zapisz",
        deleteButton: "Usuń",
        permissionCaption: "Działania uruchamiane klawiszami i przyciskiem bocznym myszy wymagają uprawnienia Dostępność.",
        manageButton: "Zarządzaj menu",
        panelCaption: "Ulubione działania w kole",
        mouseTriggerLabel: "Przycisk myszy",
        mouseTriggerOff: "Wyłączone",
        mouseTriggerBack: "Tylny przycisk boczny",
        mouseTriggerForward: "Przedni przycisk boczny",
        mouseTriggerWarning: "Gdy ta opcja jest włączona, przycisk nie działa już jako Wstecz ani Dalej w aplikacjach. Jeśli używasz go do nawigacji, pozostaw tę opcję wyłączoną.",
        buttonTestLabel: "Test przycisku",
        buttonTestWaiting: "Naciśnij teraz przycisk",
        buttonTestSeen: "Vorssaint wykrywa ten przycisk",
        buttonTestOther: "To był inny przycisk",
        buttonTestBlind: "Vorssaint nie może teraz monitorować myszy",
        buttonTestHint: "Jeśli nic się nie podświetla, macOS nie przekazuje tego przycisku aplikacjom. Myszy z własnym oprogramowaniem często przypisują przyciski boczne do innych funkcji. Zmień to w tym oprogramowaniu albo przypisz przyciskowi kombinację klawiszy i użyj jej powyżej.",
        activationModeLabel: "Sposób otwierania",
        activationModePressOrHold: "Naciśnij lub przytrzymaj",
        activationModePress: "Naciśnij, aby otworzyć",
        activationModeHold: "Przytrzymaj, aby wybrać",
        activationModeCaption: "Naciśnięcie lub przytrzymanie zachowuje bieżący gest adaptacyjny. Naciśnięcie pozostawia menu otwarte, a przytrzymanie uruchamia wyróżnione działanie po puszczeniu.",
        profilesHeader: "Profile",
        profilePickerLabel: "Profil",
        addProfileButton: "Dodaj profil",
        duplicateProfileButton: "Duplikuj profil",
        deleteProfileButton: "Usuń profil",
        profileNameLabel: "Nazwa profilu",
        profileColorLabel: "Kolor",
        profileShortcutLabel: "Skrót",
        profileMouseTriggerLabel: "Przycisk myszy",
        presetGeneral: "Ogólne",
        presetMedia: "Multimedia",
        presetTools: "Narzędzia",
        presetWindowLayout: "Układ okien",
        presetQuickToggles: "Szybkie przełączniki",
        presetBlank: "Pusty",
        colorAccent: "Akcent",
        colorBlue: "Niebieski",
        ...
        colorCyan: "Cyjan",
        colorIndigo: "Indygo",
        colorGraphite: "Grafitowy",
        fetchFaviconButton: "Pobierz ikonę witryny",
        fetchFaviconDisclaimer: "Jednorazowo łączy się z witryną, aby pobrać jej ikonę. Ikona jest zapisywana lokalnie.",
        fetchFaviconLoading: "Pobieranie ikony…",
        fetchFaviconSuccess: "Ikona pobrana",
        fetchFaviconError: "Nie znaleziono ikony witryny",
        mouseTriggerRequirement: "Działają tutaj tylko dodatkowe przyciski myszy. Przy gładziku lub myszy bez dodatkowych przycisków użyj powyższego skrótu klawiaturowego.",
        canvasHint: "Kliknij przycisk, aby wybrać uruchamiane działanie albo go usunąć. Przeciągnij przycisk, aby zmienić jego położenie.",
        resetActionsButton: "Resetuj",
        resetActionsConfirm: "Zresetuj działania",
        resetActionsConfirmMessage: "Przywrócić domyślne działania tego profilu? Własne działania zostaną zastąpione.",
        showListButton: "Pokaż jako listę",
        hideListButton: "Ukryj listę"
    )
