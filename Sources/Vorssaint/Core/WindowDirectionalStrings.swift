...
struct WindowDirectionalStrings {
    ...
    static func localized(_ language: AppLanguage) -> WindowDirectionalStrings {
        ...
        case .pl: return .init(title: "Skrót + wskaźnik", caption: "Przytrzymaj skrót, przesuń wskaźnik w stronę krawędzi lub rogu, a następnie puść, aby umieścić aktywne okno.")
