...
extension ScreenshotFeatureStrings {
    ...
    static let pl = ScreenshotFeatureStrings(
        pageTitle: "Zrzut ekranu",
        hubDescription: "Przechwytuj obszar, okno lub ekran i dodawaj adnotacje",
        captureButton: "Zrób zrzut teraz",
        panelCaption: "Przechwyć obszar, okno lub cały ekran",
        fileNamePrefix: "Zrzut ekranu",
        hintDrag: "Przeciągnij, aby zaznaczyć obszar",
        hintClick: "Kliknij okno, aby je przechwycić",
        hintFullScreen: "Return przechwytuje cały ekran",
        hintCancel: "Esc anuluje",
        hintRepeat: "R powtarza ostatni obszar",
        freezeToggle: "Zamrażaj ekran podczas zaznaczania",
        freezeCaption: "Obraz zatrzymuje się na czas wyboru obszaru, więc nic nie przesuwa się ani nie zmienia podczas zaznaczania.",
        folderLabel: "Zapisuj w",
        folderChoose: "Wybierz…",
        subfolderLabel: "Wzorzec podfolderów",
        subfolderCaption: "Opcjonalne. Tworzy datowane podfoldery we wskazanym folderze, używając %y, %year, %mo, %month, %d, %h, %mi i %s, np. %y-%mo dla 24-03.",
        fileNamePatternLabel: "Nazwa pliku",
        fileNamePatternCaption: "Opcjonalne. Zastępuje domyślną nazwę tymi samymi znacznikami %y, %year, %mo, %month, %d, %h, %mi i %s oraz %# dla automatycznie zwiększanego numeru (%## daje 2 cyfry, %### daje 3 itd.).",
        fileNumberStartLabel: "Zacznij od",
        fileNumberResetButton: "Resetuj",
        fileNumberNextFormat: "Następny: %d",
        delayLabel: "Opóźnienie",
        delayOff: "Wyłączone",
        delaySecondsFormat: "%d s",
        pointerToggle: "Dołącz wskaźnik",
        downscaleToggle: "Zapisuj w rozmiarze 1x",
        downscaleCaption: "Zrzuty Retina są zapisywane w połowie rozmiaru pikselowego, dzięki czemu pliki są mniejsze.",
        editorTitle: "Zrzut ekranu",
        toolShortcutsTitle: "Narzędzia edytora",
        toolShortcutsToggle: "Używaj skrótów narzędzi",
        toolShortcutsCaption: "Kliknij skrót, aby nagrać kombinację klawiszy. Cyfry 1–9 zmieniają narzędzie. Delete usuwa jego skrót.",
        toolShortcutReserved: "Ten klawisz należy do edytora.",
        toolSelect: "Zaznaczanie",
        toolArrow: "Strzałka",
        arrowStyleLabel: "Styl strzałki",
        arrowStyleFilled: "Pełna",
        arrowStyleOutline: "Konturowa",
        arrowStyleOpen: "Otwarta",
        arrowStyleDoubleEnded: "Dwustronna",
        arrowStyleScribbly: "Od­ręczna",
        toolLine: "Linia",
        toolRect: "Prostokąt",
        toolEllipse: "Elipsa",
        toolFreehand: "Pióro",
        toolHighlight: "Zakreślacz",
        toolText: "Tekst",
        toolSticker: "Naklejka",
        toolCounter: "Numer",
        toolPixelate: "Pikselizacja",
        toolRedact: "Pełne zasłonięcie",
        toolCrop: "Kadrowanie",
        ...
        blurStrengthLabel: "Siła rozmycia",
        shadowLabel: "Cienie",
        backdropLabel: "Tło",
        backdropNone: "Brak",
        editButton: "Edytuj",
        copyButton: "Kopiuj",
        saveButton: "Zapisz",
        saveAsButton: "Zapisz jako…",
        pinButton: "Przypnij do ekranu",
        copyTextButton: "Kopiuj tekst",
        discardTitle: "Odrzucić ten zrzut ekranu?",
        discardMessage: "Nie został jeszcze skopiowany ani zapisany.",
        discardConfirm: "Odrzuć",
        copiedHUD: "Zrzut ekranu skopiowany",
        savedHUDFormat: "Zapisano w %@",
        savedAndCopiedHUDFormat: "Zapisano w %@ i skopiowano",
        defaultActionLabel: "Domyślne działanie",
        defaultActionCaption: "Uruchamiane automatycznie zaraz po przechwyceniu. Nadal pojawi się potwierdzenie, więc możesz później edytować lub odrzucić zrzut.",
        defaultActionNone: "Pytaj za każdym razem",
        defaultActionSaveAndCopy: "Zapisz i kopiuj",
        captureFailed: "Nie udało się przechwycić ekranu",
        pinOpacity: "Krycie",
        pinClickThrough: "Ignoruj kliknięcia",
        pinCloseAll: "Zamknij wszystkie przypięte zrzuty",
        backdropPaddingLabel: "Margines",
        backdropWallpaperLabel: "Tapeta",
        backdropImageButton: "Obraz…",
        backdropSolidLabel: "Jednolity",
        backdropGradientLabel: "Gradient",
        backdropCornersLabel: "Zaokrąglenia rogów",
        backdropSavePreset: "Zapisz tło",
        backdropDeletePreset: "Usuń",
        backdropCustomLabel: "Niestandardowe",
        openEditorToggle: "Otwieraj edytor od razu po przechwyceniu",
        openEditorCaption: "Przechwycenie pomija pływający podgląd i otwiera się od razu z narzędziami do adnotacji.",
        autoCopyToggle: "Automatycznie kopiuj do schowka",
        autoCopyCaption: "Każdy zrzut trafia do schowka od razu po wykonaniu i jest gotowy do wklejenia. Zapis pliku pozostaje osobnym wyborem.",
        hintLoupe: "Z przełącza lupę",
        lastRegionToggle: "Pokazuj obrys ostatniego przechwycenia",
        backdropBlurLabel: "Rozmycie",
        scrollingCaptureButton: "Przewijany zrzut",
        scrollingCaptureTitle: "Przechwytywanie przewijanej strony",
        scrollingCaptureProgressHUD: "Przewijaj myszą lub gładzikiem. Naciśnij Enter albo wybierz Gotowe.",
        scrollingCaptureHintOff: "S przełącza przewijanie",
        scrollingCaptureHintOn: "Przewijanie włączone",
        scrollingCaptureTooLongHUD: "Przechwytywanie zatrzymane po osiągnięciu bezpiecznego limitu",
        editLastCapture: "Edytuj najnowszy zrzut",
        lastCaptureMissing: "Najpierw zrób zrzut ekranu",
        fullScreenShortcutTitle: "Przechwyć cały ekran",
        bringForward: "Przenieś na wierzch",
        sendBackward: "Przenieś do tyłu",
        shareSectionTitle: "Tymczasowe linki",
        shareCaption: "Przy udostępnianiu wybierz 1, 6 lub 24 godziny. Obraz zostanie automatycznie usunięty.",
        shareButton: "Udostępnij",
        shareOneHour: "Na 1 godzinę",
        shareSixHours: "Na 6 godzin",
        shareTwentyFourHours: "Na 24 godziny",
        sharingHUD: "Tworzenie linku…",
        sharedHUD: "Link skopiowany",
        shareFailedHUD: "Nie udało się utworzyć linku",
        sharedLinksTitle: "Udostępnione linki",
        sharedLinksEmpty: "Brak aktywnych linków",
        expiresLabel: "Wygasa",
        deleteLink: "Usuń teraz",
        linkDeletedHUD: "Link usunięty",
        deleteFailedHUD: "Nie udało się usunąć linku",
        openLink: "Otwórz",
        copyLink: "Kopiuj link",
        done: "Gotowe",
        sharePrivacyButton: "Prywatność",
        sharePrivacyTitle: "Prywatność tymczasowych linków",
        sharePrivacyData: "Vorssaint wysyła tylko wyrenderowany obraz i wybrany czas wygaśnięcia. Nie wysyła imienia i nazwiska, konta, identyfikatora urządzenia ani adresu MAC. Na tym Macu przechowuje tylko link, czas wygaśnięcia i prywatny token usuwania, dopóki link jest aktywny.",
        sharePrivacyStorage: "Operatorzy sieci i usługa tymczasowo przetwarzają Twój publiczny adres IP w celu ochrony przed nadużyciami. Obraz i metadane linku są trwale usuwane po usunięciu linku lub upływie jego ważności. Usługa nie tworzy kopii zapasowych zrzutów.",
        sharePrivacyAccess: "Każdy, kto ma link, może wyświetlać, pobierać, zapisywać i dalej udostępniać obraz. Aktywne linki są dostępne operatorowi usługi w celu moderacji nadużyć. Udostępniaj je tylko zaufanym osobom.",
        scrollingCaptureCaption: "Wybierz obszar, przewijaj myszą lub gładzikiem, a następnie naciśnij Enter albo Gotowe, aby połączyć kolejne fragmenty.",
        scrollingCaptureSelectionHint: "Przeciągnij tylko po tej części strony, która się przesuwa.",
        scrollingCapturePartialHUD: "Strona się zmieniła. Zachowano ukończoną część.",
        previewPositionLabel: "Położenie podglądu",
        previewPositionAutomatic: "Automatyczne",
        previewPositionTopLeft: "Lewy górny róg",
        previewPositionTopRight: "Prawy górny róg",
        previewPositionBottomLeft: "Lewy dolny róg",
        previewPositionBottomRight: "Prawy dolny róg",
        previewFocusToggle: "Automatycznie ustawiaj fokus na podglądzie",
        previewFocusCaption: "Skróty działają od razu po pojawieniu się podglądu, ale klawiatura pozostaje poza używaną aplikacją do czasu jego zamknięcia.",
        hideVorssaintWindowsToggle: "Ukrywaj okna Vorssaint",
        shareEnabledToggle: "Zezwalaj na tymczasowe linki",
        editClipboardImage: "Edytuj obraz ze schowka",
        clipboardImageMissing: "Najpierw skopiuj obraz",
        showCaptureMenuOnShortcut: "Pokazuj menu przechwytywania przy użyciu skrótu klawiaturowego",
        screenCaptureTitle: "Przechwytywanie ekranu",
        dragOutHandleLabel: "Przeciąganie",
        loupeStartsOnToggle: "Rozpoczynaj zaznaczanie z włączoną lupą",
        loupeRememberZoomToggle: "Zapamiętuj ostatnie powiększenie lupy",
        loupeDefaultZoomLabel: "Domyślne powiększenie lupy",
        loupeWheelZoomLabel: "Powiększenie kółkiem",
        loupeZoomFast: "Szybkie",
        loupeZoomStepped: "Stopniowe",
        loupeZoomOptionCaption: "Przytrzymaj ⌥, aby tymczasowo użyć drugiego trybu.",
        watermarkLabel: "Znak wodny",
        watermarkImageLabel: "Obraz",
        watermarkTextPlaceholder: "Tekst znaku wodnego",
        watermarkPositionLabel: "Położenie",
        watermarkSizeLabel: "Rozmiar",
        watermarkOpacityLabel: "Krycie",
        watermarkRotationLabel: "Obrót",
        watermarkSavePreset: "Zapisz znak wodny",
        watermarkColorRed: "Czerwony",
        watermarkColorOrange: "Pomarańczowy",
        watermarkColorYellow: "Żółty",
        watermarkColorGreen: "Zielony",
        watermarkColorBlue: "Niebieski",
        watermarkColorPurple: "Fioletowy",
        watermarkColorBlack: "Czarny",
        watermarkColorWhite: "Biały",
        watermarkPositionTopLeading: "Lewy górny róg",
        watermarkPositionTop: "Góra — środek",
        watermarkPositionTopTrailing: "Prawy górny róg",
        watermarkPositionLeading: "Środek — lewo",
        watermarkPositionCenter: "Środek",
        watermarkPositionTrailing: "Środek — prawo",
        watermarkPositionBottomLeading: "Lewy dolny róg",
        watermarkPositionBottom: "Dół — środek",
        watermarkPositionBottomTrailing: "Prawy dolny róg"
    )
