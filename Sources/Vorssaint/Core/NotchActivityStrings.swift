...
extension FeatureStrings {
    static func notchActivities(_ language: AppLanguage) -> NotchActivityStrings {
        ...
        case .zhTW: return NotchActivityStrings(
            ...
            connected: "已連接",
            lowBattery: "電量不足")
        case .pl: return NotchActivityStrings(
            timer: "Timer",
            timerDescription: "Timery, stoper i sesje skupienia w Dynamic Island.",
            pomodoro: "Pomodoro",
            stopwatch: "Stoper",
            focus: "Skupienie",
            shortBreak: "Krótka przerwa",
            longBreak: "Długa przerwa",
            pomodoroHint: "Rozpoczynaj każdą fazę, gdy będziesz gotowy. Cykl kończy się po ostatniej sesji skupienia.",
            totalSessions: "Liczba sesji",
            longBreakInterval: "Sesje między długimi przerwami",
            sessionProgress: "Sesja %d z %d",
            pomodoroFinished: "Pomodoro zakończone",
            minutes: "Minuty",
            start: "Start",
            resume: "Wznów",
            finished: "Czas minął",
            soundEnabled: "Odtwórz dźwięk po upływie czasu",
            camera: "Podgląd z kamery",
            cameraUnavailable: "Nie udało się uruchomić kamery. Spróbuj otworzyć ją ponownie.",
            cameraHint: "Otwórz tutaj podgląd na żywo. Kamera wyłącza się po opuszczeniu tego widoku.",
            startCamera: "Otwórz kamerę",
            stopCamera: "Zatrzymaj kamerę",
            accessories: "Alerty akcesoriów",
            accessoryDescription: "Pokazuj podłączone akcesoria i ostrzegaj raz, gdy poziom ich baterii spadnie do 20%.",
            connected: "Połączone",
